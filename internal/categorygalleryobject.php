...
<?php
    foreach($catData as $currCat){
        ...
        ?>
        <div class="col w-100 align-items-center justify-content-center align-middle text-center <?php if(str_contains($_SERVER["REQUEST_URI"], "shop.php")){echo "pb-3";} ?>" style="display:inline-block;min-width:200px!important;max-width:230px!important;">
            ...
            <button id="prodShoppingBtn" data-value="<?php echo($currCat[0]); ?>" onclick="window.location.href = '/shop.php?category='+this.dataset.value" class="w-100 btn btn-primary ahvbutton flex-row fw-normal rounded-pill fs-5 align-middle text-center border-0 px-4 py-2 prodShoppingBtn">
