<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $addTrackingSQL = "INSERT INTO products (prod_name, prod_img_url, prod_price, prod_stock, prod_temp, cat_id) VALUES (?, ?, ?, ?, ?, ?)";
        if ($stmt=mysqli_prepare($conn, $addTrackingSQL)){
            mysqli_stmt_bind_param($stmt, "ssssii", $product_name, $product_imgurl, $product_price, $product_stock, $product_temp, $cat_id);
