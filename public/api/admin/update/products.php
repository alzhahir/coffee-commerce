<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $editProdSQL = "UPDATE products SET prod_name = ?, prod_img_url = ?, prod_price = ?, prod_stock = ?, prod_temp = ?, cat_id = ? WHERE prod_id = $pid";
        if ($stmt=mysqli_prepare($conn, $editProdSQL)){
            mysqli_stmt_bind_param($stmt, "ssssii", $product_name, $product_imgurl, $product_price, $product_stock, $product_temp, $category_id);
